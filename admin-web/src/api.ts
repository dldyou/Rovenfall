    ...
    context.registerTool(
      {
        ...
        description:
          'Search the connected Rovenfall server player directory by nickname or UUID.',
        inputSchema: {
          type: 'object',
          properties: {
    ...
    context.registerTool(
      {
        ...
        description:
          'Read bounded Rovenfall audit records, optionally filtered by player and action.',
        inputSchema: {
          type: 'object',
          properties: {
        ...
        async execute(input) {
          ...
          const page =
            Number.isInteger(value.page) && Number(value.page) >= 0
              ? Number(value.page)
              : 0;
          return apiRequest<PageData<AuditRow>>(
            token,

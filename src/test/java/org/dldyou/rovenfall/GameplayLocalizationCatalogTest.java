...
final class GameplayLocalizationCatalogTest {
    private static final Set<String> REQUIRED_KEYS = Set.of(
            ...
            "message.rovenfall.level_up.title",
            "message.rovenfall.level_up.milestone",
            "message.rovenfall.level_up.mastery",
            ...
            "key.rovenfall.journey_screen",
            "key.rovenfall.skills_screen",
            "key.rovenfall.land_screen",
            ...
            "item.rovenfall.trail_ration",
            "item.rovenfall.rimeblade",
            "item.rovenfall.deepstone_pickaxe",
            "enchantment.rovenfall.rime_edge",
            "enchantment.rovenfall.delvers_reach",
            "gui.rovenfall.quest.daily_tasks",
            "gui.rovenfall.quest.daily_tasks.hint",
            "gui.rovenfall.quest.daily_tasks.all",
            "gui.rovenfall.quest.daily_tasks.cooking",
            "gui.rovenfall.quest.daily_tasks.filter",
            "gui.rovenfall.quest.daily_tasks.progress",
            "gui.rovenfall.quest.daily_tasks.claim",
            "item.rovenfall.orchard_pie",
            "daily_contract.rovenfall.trail_ration_supplies",
            "daily_contract_description.rovenfall.trail_ration_supplies",
            "daily_contract.rovenfall.orchard_pie_supplies",
            "daily_contract_description.rovenfall.orchard_pie_supplies",
